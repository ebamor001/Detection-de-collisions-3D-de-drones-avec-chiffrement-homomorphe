...
public:
    ...
    // Version purement homomorphe : les deux segments arrivent en clair ici,
    // mais tous les calculs (cross-product, coplanarité, orientations) se font
    // sur des ciphertexts — aucune coordonnée n'est déchiffrée.
    // Format d'entrée : [x1, y1, z1, x2, y2, z2] dans les 6 premiers slots.
