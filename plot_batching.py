...
BINARY      = os.path.join(PROJECT_DIR, "build", "drone_batching")
...
for r in [r1, r2, r4, r5, r6]:
    if r is None: continue
    n_col_clear = int(r.get("clear_collision_count", r.get("collision_count", 0)))
    n_total     = int(r.get("segments_tested", 1))
    fhe_col     = int(r.get("collision_count", 0))
